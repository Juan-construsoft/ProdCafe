...
namespace HipatiaVentas.Migrations
{
    ...
    public partial class cargainicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RegistroCataciones",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FechaPrueba = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Predio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Lote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VariedadId = table.Column<int>(type: "int", nullable: false),
                    MetodoId = table.Column<int>(type: "int", nullable: false),
                    FraganciaAroma = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Sabor = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SaborResidual = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Acidez = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Cuerpo = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Uniformidad = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Dulzor = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    LimpiezaTaza = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Balance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Global = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistroCataciones", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "RegistroTostiones",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    PesoPergamino = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TipoProcesoId = table.Column<int>(type: "int", nullable: false),
                    PesoTrillado = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PesoTostado = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TipoMoliendaId = table.Column<int>(type: "int", nullable: false),
                    ValorParcial = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistroTostiones", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CantidadEfectivo = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    MotivoMovimiento = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreateUser = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedUser = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Codigo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CodigoUnificado = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Vencimiento = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParametrosGenerales_TipoCategorias_TipoCategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioMayoreo = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Subtotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreateUser = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "b74ddd14-6340-4840-95c2-db12554843e5", 0, "63b64d25-bb9e-42aa-8a7b-1f200066f94c", "ApplicationUser", "admin@gmail.com", true, false, null, null, null, "AQAAAAIAAYagAAAAEI5ejF5EUwKfgtP78wp8sEffLxUWpctcKYhWvp+hOCX1coSKnP2D7iLv+hFCepfAeA==", "3075357780", false, "5833d234-7797-4ab3-8f34-3104a74cfdd3", false, "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParametrosGenerales_TipoCategoriaId",
